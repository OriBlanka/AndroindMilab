    ...
    private void LogUserIn(String email, String password){
        ...
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST,  SERVER_ADDRESS + email + "/check",
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    boolean match = response.getBoolean("match");
                    ...
                    e.printStackTrace();
                    resetInputs();
                    Log.e(ACTIVITY_TAG,"got a json exception");
                    Toast.makeText(LoginActivity.this, "Error! Please re-enter username and password", Toast.LENGTH_SHORT).show();
                }
            }
        },
